...
<title>Assessment Methodology — EnterpriseSecurityIQ</title>
<style>{get_css()}</style>
</head>
<body>
  ...
  <main class="content" id="main-content">
    <div class="section" id="overview">
      ...
      <div class="conf-notice">
        &#128196; This report describes <strong>how</strong> the EnterpriseSecurityIQ assessment was conducted,
    ...
    <div class="section" id="pipeline">
      ...
      <p style="color:var(--text-secondary);margin-bottom:16px">
        EnterpriseSecurityIQ follows a deterministic 4-phase pipeline. Each phase is isolated and produces
    ...
    <div class="section" id="access-denied">
      ...
      <p style="color:var(--text-secondary);margin-bottom:16px">
        When the authenticated user lacks permissions for specific APIs, EnterpriseSecurityIQ records the
    ...
    <div class="section" id="verification">
      ...
      <div style="background:var(--bg-card);border:1px solid var(--border);border-radius:12px;padding:24px;margin-bottom:24px">
        ...
        <ol style="color:var(--text-secondary);font-size:13px;line-height:2;padding-left:20px">
          ...
          <li><strong>Control Mappings:</strong> Review the framework mapping files in <code>AIAgent/app/frameworks/</code> to see exactly which evidence types each control requires.</li>
          <li><strong>Evaluator Logic:</strong> The evaluation rules are in <code>AIAgent/app/evaluators/</code> — deterministic Python functions with no external dependencies.</li>
    ...
    <div style="text-align:center;color:var(--text-muted);font-size:12px;padding:32px 0;border-top:1px solid var(--border)">
      EnterpriseSecurityIQ Methodology Report &middot; Generated {format_date(now)} &middot; v2.0
    </div>
  </main>
</div>
