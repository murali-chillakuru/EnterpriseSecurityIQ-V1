...
def generate_markdown_report(
    ...
    path = out / f"EnterpriseSecurityIQ-Report-{ts}.md"
    ...
    # Header
    lines.append("# EnterpriseSecurityIQ Compliance Report\n")
    ...
    # Footer
    lines.append("---\n")
    lines.append("*Generated by EnterpriseSecurityIQ AI Agent v1.0*\n")
